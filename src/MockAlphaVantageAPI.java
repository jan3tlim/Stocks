...
/**
 * The MockAlphaVantageAPI class provides a mock implementation of the AlphaVantageAPI for
 * testing purposes.
...
class MockAlphaVantageAPI extends AlphaVantageAPI {
   ...
   * @return an instance of MockStock with the provided ticker and an empty TreeMap for
   *                      historical data.
