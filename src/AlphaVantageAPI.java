...
public class AlphaVantageAPI implements  APIInterface{
  ...
  /**
   * Creates a Stock object by fetching historical data for the given ticker.
   *
   * @param ticker the stock ticker symbol
   * @return a Stock object containing the ticker and its historical prices
  ...
  /**
   * Main method for testing the AlphaVantageAPI class.
   *
