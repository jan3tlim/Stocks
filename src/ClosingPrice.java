...
/**
 * The ClosingPrice class implements the StockInformationCommands interface to provide
...
public class ClosingPrice implements StockInformationCommands {
  ...
  /**
   * Constructs a ClosingPrice instance with the specified view and scanner.
   *
