...
public class StockControllerTest {
   ...
   * @return An Interaction that appends the lines to the output.
   */
   ...
   * @return An Interaction that appends the input string to the input.
   */
  ...
  void testRun(Interaction... interactions) throws IOException {
    ...
    IStockController controller = new StockController(input, actualOutput);
  ...
  public void testForStockInformation() throws IOException {
    ...
    testRun(prints("Welcome to Stocks!\n\n" +
                    ...
                    "2. Manage your portfolio(s)\n\n"),
            inputs("1\n"),
            prints("Enter 'b' to come back to the most recent menu.\n" +
