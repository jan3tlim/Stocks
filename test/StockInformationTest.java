...
public class StockInformationTest {
  ...
  public void testGo() {
    ...
    expected.append("Stock Information:\n\n");
    expected.append("Popular Stock Tickers:\nAAPL GOOG AMZN\n\n");
    ...
    expected.append("3. Get X-Day Moving Average\n");
    expected.append("4. Get X-Day Crossover\n");
    expected.append("Enter 'b' to come back to the most recent menu.\nTo quit the program, "
            + "navigate back to main menu.\n");
